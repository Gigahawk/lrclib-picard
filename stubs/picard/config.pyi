...
class ConfigSection(QtCore.QObject):
    ...
    def raw_value(self, name, qtype: Incomplete | None = None): ...
    def value(self, name, option_type, default: Incomplete | None = None): ...
...
class SettingConfigSection(ConfigSection):
    ...
    def __getitem__(self, name): ...
    def __setitem__(self, name, value) -> None: ...
    def set_profiles_override(self, new_profiles: Incomplete | None = None) -> None: ...
    def set_settings_override(self, new_settings: Incomplete | None = None) -> None: ...
...
class Config(QtCore.QSettings):
    ...
    def run_upgrade_hooks(self, outputfunc: Incomplete | None = None) -> None: ...
...
def setup_config(app, filename: Incomplete | None = None) -> None: ...
def get_config(): ...
def load_new_config(filename: Incomplete | None = None): ...
